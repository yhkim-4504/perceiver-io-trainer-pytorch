...
{str_y0_list}
    ...
    def train(self, print_plot=True):
        ...
        for epoch in range(self.start_epoch, self.epochs+1):
            ...
            for batch, (x, y, seqs) in enumerate(self.train_loader):
                ...
                mean_train_loss = self.forward_and_update(x, y, seqs, train_losses)
    ...
    def forward_and_update(self, x, y, seqs, train_losses):
        predicted = self.forward_model(x, seqs).unsqueeze(-1)
    ...
    def forward_model(self, batch_x, seqs):  # forward
    ...
    def process_validation(self, dataloader):
        ...
        with torch.no_grad():
            ...
            for batch, (x, y, seqs) in enumerate(dataloader):
                ...
                out = self.forward_model(x, seqs).unsqueeze(-1)
